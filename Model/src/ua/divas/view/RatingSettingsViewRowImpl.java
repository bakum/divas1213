...
import ua.divas.model.RatingSettingsImpl.AttributesEnum;
// ---------------------------------------------------------------------
...
public class RatingSettingsViewRowImpl extends ViewRowImpl {
    ...
    /**
     * Gets the attribute value for CNT_KG_DIVIDER using the alias name CntKgDivider.
     * @return the CNT_KG_DIVIDER
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for CNT_KG_DIVIDER using the alias name CntKgDivider.
     * @param value value to set the CNT_KG_DIVIDER
     */
    ...
    /**
     * Gets the attribute value for the calculated attribute CntKgBal.
     * @return the CntKgBal
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for CNT_KG_BAL using the alias name CntKgBal.
     * @param value value to set the CNT_KG_BAL
     */
